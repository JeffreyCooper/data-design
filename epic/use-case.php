...
Ellen wants to find a crafting idea to create a gift echo 's birthday. 
User Story: As a user, I want to download a file describing how to build a cat condo;
	
	As a user, I want to download a file describing how to build a cat condo;
1. Go to www.data-design.com
2. Search for Cat Condo Design
3. Click to view Cat Condo Design
4. Click to download PDF file of Cat Condo Design.