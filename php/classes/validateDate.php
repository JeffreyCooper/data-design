 ...
 *
 * This trait will inject a private method to validate a mySQL style date (i.e., 2016-01-15 15:32:48.643216). It will convert a string representation to a DateTime object or throw an exception.
 *
 * First trait = date only
 * Second trait = date and time
 * Third trait = time only
 *
